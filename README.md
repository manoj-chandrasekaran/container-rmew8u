...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rmew8u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rmew8u.containers.anotherwebservice.com/
...
```
git clone git@github.com:manoj-chandrasekaran/container-rmew8u.git
cd container-rmew8u
```
...
```
docker attach container-rmew8u
```
